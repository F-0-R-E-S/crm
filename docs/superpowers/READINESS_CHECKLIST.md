...
- [x] Docs hybrid search — pgvector + BM25 + RRF + Cmd+K + reindex cron — #2026-04-22-docs-04
- [x] Docs API reference — `/docs/api` integrated + OpenAPI indexed + Cmd+K badge — #2026-04-22-docs-05
- [x] Docs local LLM Q&A — SSE route + widget + full chat + eval harness + runbook (Fly GPU pending) — #2026-04-22-docs-06
- [x] Docs staleness digest — weekly Telegram digest for under-documented topics — #2026-04-22-docs-07 (task 7)
