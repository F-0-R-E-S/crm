...
export async function resetDb() {
  ...
  await prisma.$transaction([
    ...
    prisma.affiliateInvoice.deleteMany(),
    prisma.brokerInvoice.deleteMany(),
    prisma.cRGCohort.deleteMany(),
    prisma.affiliatePayoutRule.deleteMany(),
    prisma.brokerPayoutRule.deleteMany(),
    ...
    prisma.statusMapping.deleteMany(),
    prisma.broker.deleteMany(),
    prisma.canonicalStatus.deleteMany(),
