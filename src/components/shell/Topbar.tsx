  ...
  return (
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <div className="pulse" style={{ width: 7, height: 7, borderRadius: 7, background: "oklch(78% 0.14 150)", boxShadow: "0 0 8px oklch(78% 0.14 150)" }} />
        <span style={{ fontSize: 11, fontFamily: "var(--mono)", color: fg, letterSpacing: "0.04em" }}>
          intake live · {rate}/day
        </span>
      </div>
      <div style={{ flex: 1 }} />
      <button type="button" onClick={() => setTheme(theme === "dark" ? "light" : "dark")} style={btnStyle(theme)}>
