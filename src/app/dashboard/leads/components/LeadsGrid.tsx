    ...
    <div style={{ padding: "0 28px" }}>
      ...
      >
        ...
        <thead>
          ...
          >
            <th style={{ padding: "8px 4px" }}>trace_id</th>
            <th>time</th>
            <th>affiliate</th>
            <th>geo</th>
            <th>phone</th>
          ...
          {leads.map((l) => {
            ...
            return (
              <tr
                ...
                onMouseEnter={(e) => {
                  if (!sel) e.currentTarget.style.background = hoverBg;
                }}
                onMouseLeave={(e) => {
                  if (!sel)
                    e.currentTarget.style.background = isNew
                      ? "rgba(120,210,150,0.06)"
                      : "transparent";
                }}
              >
                <td
                ...
                <td style={{ fontFamily: "var(--mono)", color: "var(--fg-1)" }}>
                ...
                <td>
                  <StatePill state={l.state as never} />
                </td>
                <td
                  style={{
                    fontFamily: "var(--mono)",
