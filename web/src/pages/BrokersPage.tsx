...
export default function BrokersPage() {
  ...
  const { data: brokersData, isLoading: loadingBrokers } = useQuery({
    queryKey: ["brokers", page, normalizedSearch, statusFilter],
    queryFn: () => {
      ...
      return api.get<{ brokers: Broker[]; total: number }>(
  ...
  const { data: templatesData } = useQuery({
    ...
    queryFn: () =>
      api.get<{ templates: BrokerTemplate[]; total: number }>(
        "/broker-templates",
      ),
  });
  ...
  const total = brokersData?.total ?? 0;
  ...
  return (
    <div className="page-section">
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "var(--text-2)", marginTop: 2 }}>
            {total > 0
              ? `${total.toLocaleString()} brokers in view`
      ...
      <ListToolbar
        ...
        searchPlaceholder="Search brokers, templates, or endpoints…"
        summary={
          hasFilters ? (
            <button
              className="btn-ghost"
          ...
          <tbody>
            {loadingBrokers ? (
              ...
              <tr>
                ...
                >
                  {hasFilters
                    ? "No brokers matched the current filters."
                    : "No brokers found."}
                </td>
              </tr>
            ) : (
                ...
                <tr key={broker.id}>
                  ...
                  <td>
                    <span
                      className={clsx(
                        "status-badge",
                        getHealthBadge(broker.health_status),
                      )}
                    >
          ...
          >
            <div className="form-header">
              <div>
                <div className="form-title">
                  {editingBrokerId ? "Edit Broker" : "Add Broker Integration"}
                </div>
                <div className="form-subtitle">
                  Real broker records are stored in backend and used by routing
                  services.
                </div>
              </div>
              <button
            ...
            <div className="form-grid form-grid-2">
              <div className="form-field">
                <label className="form-label" htmlFor="broker-name">
                  Broker Name
                </label>
                <input
                  id="broker-name"
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="broker-template">
                  Template
                </label>
                <select
                  id="broker-template"
              ...
              <div className="form-field" style={{ gridColumn: "1 / -1" }}>
                <label className="form-label" htmlFor="broker-endpoint">
                  API Endpoint
                </label>
                <input
                  id="broker-endpoint"
              ...
              <div className="form-field" style={{ gridColumn: "1 / -1" }}>
                <label className="form-label" htmlFor="broker-key">
                  API Key
                </label>
                <input
                  id="broker-key"
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="broker-cap">
                  Daily Cap
                </label>
                <input
                  id="broker-cap"
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="broker-priority">
                  Priority
                </label>
                <input
                  id="broker-priority"
              ...
              <div className="form-field">
                <label className="form-label" htmlFor="broker-status">
                  Status
                </label>
                <select
                  id="broker-status"
                  ...
                  onChange={(e) =>
                    setForm((prev) => ({
                      ...prev,
                      status: e.target.value as Broker["status"],
                    }))
                  }
                >
